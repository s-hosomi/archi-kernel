// Demo building: a three-storey RC office block, modelled as archi-kernel CSG
// and evaluated by the kernel at load time.
//
...
export const CURVED_KIND_OF = new Map();
export const CURVED_PANELS = [];
export const DEMO = {
  id: 'office',
  label: 'CSG office',
  description: 'Prismatic CSG office model',
};
export const BOUNDS = {
...
export const VIEW = {
  target: [9.6, 5.6, 4.6],
  heroCamera: [34.5, -26.0, 18.6],
  heroTarget: [10.4, 5.0, 6.5],
  sectionCamera: [28.5, -22.0, 19.2],
  sectionTarget: [9.0, 5.1, 4.0],
  sectionZ: 8.45,
};
